    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
        ...
        <div className="flex items-center gap-4">
          {!isSignedIn ? (
            <>
              ...
              <Link
                href="/sign-up"
                className="px-5 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold hover:opacity-90 transition"
              >
                Get Started
              </Link>
            </>
            ...
            <Link
              href="/app/dashboard"
              className="px-5 py-2 rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold hover:opacity-90 transition"
            >
              Go to Dashboard
            </Link>
          )}
      ...
      <section className="px-6 md:px-20 mt-20 text-center">
        ...
        <div className="flex justify-center gap-4">
          <Link
            href="/sign-up"
            className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 text-white text-lg font-semibold hover:opacity-90 transition"
          >
            Start Free
          </Link>
      ...
      <section className="mt-28 px-6 md:px-20">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10">
            <h3 className="text-xl font-semibold mb-3">📅 Compliance Alerts</h3>
            <p className="text-gray-300">
          ...
          <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10">
            <h3 className="text-xl font-semibold mb-3">📦 Document Hub</h3>
            <p className="text-gray-300">
